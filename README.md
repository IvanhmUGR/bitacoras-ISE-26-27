# Bitácoras de Prácticas de Ingeniería de Servidores - Curso 26/27

Bienvenidos a la asignatura de **Ingeniería de Servidores (ISE)** del curso 26/27. Este repositorio tiene como objetivo gestionar las bitácoras individuales de los estudiantes mediante enlaces a sus repositorios privados.

Cada alumno debe crear un repositorio privado en GitHub llamado `practicas-ISE` y agregar al profesor (`orestibl`) como colaborador. Transcurrida cada lección, el estudiante deberá realizar un **pull request** (PR) a este repositorio (`bitacoras-ISE-26-27`) para agregar un enlace a su bitácora individual.
...
1. Ve a la página del repositorio del profesor: `https://github.com/orestibl/bitacoras-ISE-26-27`.
...
1. Dentro de tu fork (el repositorio que acabas de copiar a tu cuenta), dentro de la carpeta de tu subgrupo (por ejemplo `B2`), edita el fichero llamado `<practica-leccion>.md` (por ejemplo `P1-L0.md` para la lección 0 de la práctica 1).
...
-  **base repository**: `github-username-del-profesor/bitacoras-ISE-26-27`
-  **head repository**: `tu-usuario-github/bitacoras-ISE-26-27`
